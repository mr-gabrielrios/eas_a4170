...
#
time = np.linspace(0*T,1*T,1000) # Time increases evenly (chopped into 1000 pieces)
...
ax.set_title('Molniya Orbit',fontsize=24)
points = ax.scatter(lon_s*180/np.pi,lat_s*180/np.pi,c = time/T,cmap='plasma',transform = ccrs.PlateCarree())
fig.colorbar(points) 
